const routes = [
  ...
  },
  {
    ...
    children: [
      { path: '', component: () => import('pages/AdminPage.vue') },{ path: 'bugs', component: () => import('pages/AdminBuglist.vue') },{ path: 'pending', component: () => import('pages/AdminPending.vue') },{ path: 'completed', component: () => import('pages/AdminCompleted.vue') },{ path: 'create', component: () => import('pages/CreateUser.vue') }
    ]
  },
  {
    path: '/tester',
